...
public class ShortCutUtil 
{
	...
	public static void addShortcut(Context cx, int icon_id)
	{
		...
		if (hasShortcut(cx) == false) 
		{
			...
			// 快捷方式的图标
			Parcelable iconResource = Intent.ShortcutIconResource.fromContext(cx, icon_id);
	...
	public static native boolean isAlreadyAddShortcut();
}
